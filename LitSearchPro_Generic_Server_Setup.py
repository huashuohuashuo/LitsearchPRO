...
APP_ID = 'LitSearchPro_Generic_Server'
DISPLAY_NAME = '科研文献与实验室安全管理平台 协作服务器'
APP_FOLDER = '科研文献与实验室安全管理平台 协作服务器'
MAIN_EXE = 'LitSearchPro_Generic_Server_v22.1.21.exe'
PAYLOAD_UNINSTALL_EXE = 'LitSearchPro_Generic_Server_v22.1.21_Uninstall.exe'
...
STALE_KEYS = ['LitSearchPro_Generic_Server']
OLD_START_MENU_NAMES = ['科研文献与实验室安全管理平台 协作服务器']
